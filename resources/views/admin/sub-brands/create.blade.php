...
<div class="admin-card">
    <div class="admin-card-header">
        <div class="admin-header-content">
            <div>
                <h3 class="admin-card-title">子品牌網站資訊</h3>
                <p class="admin-page-description">填寫子品牌網站的基本資訊</p>
            </div>
            <div class="btn-group">
    ...
    <div class="admin-card-body">
        <form id="subBrandForm" action="{{ route('admin.sub-brands.store') }}" method="POST">
            @csrf
...
function removeLogo() {
    showAlertModal({
        ...
        onConfirm: function() {
            ...
            `;
            showNotification('Logo 已刪除', 'success');
        },
        onCancel: function() {
