...
@section('page-title', '新增團隊成員')

@section('content')
<div class="admin-header">
    <div class="admin-header-content">
        <h1 class="admin-title">新增團隊成員</h1>
        <p class="admin-description">添加新的核心團隊成員</p>
    </div>
...
<div class="admin-content">
    <form action="{{ route('admin.team-members.store') }}" method="POST" enctype="multipart/form-data" class="admin-form">
        @csrf
            ...
            <div class="form-card">
                ...
                <div class="form-card-content">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="bio" name="bio" class="form-textarea" rows="4">{{ old('bio') }}</textarea>
                        @error('bio')
                            <span class="form-error">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-card-content">
                    <div class="image-upload-area" id="image-upload-area">
                        <div class="image-preview" id="image-preview" style="display: none;">
                            <img id="preview-img" src="" alt="預覽頭像">
            ...
            <div class="form-card">
                ...
                <div class="form-card-content">
                    <div class="form-group">
                        ...
                        <input type="url" id="social_links_linkedin" name="social_links[linkedin]" class="form-input" value="{{ old('social_links.linkedin') }}" placeholder="https://linkedin.com/in/username">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="social_links_github" name="social_links[github]" class="form-input" value="{{ old('social_links.github') }}" placeholder="https://github.com/username">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="social_links_twitter" name="social_links[twitter]" class="form-input" value="{{ old('social_links.twitter') }}" placeholder="https://twitter.com/username">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="social_links_website" name="social_links[website]" class="form-input" value="{{ old('social_links.website') }}" placeholder="https://yourwebsite.com">
